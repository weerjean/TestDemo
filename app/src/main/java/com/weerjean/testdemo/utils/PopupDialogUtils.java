...
/**
 * Created by weerjean on 2018/4/1.
 */
public class PopupDialogUtils extends AlertDialog {
    private static final String TAG = "PopupDialogUtils";
    private View view;
    ...
    protected PopupDialogUtils(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(width, LinearLayout.LayoutParams.WRAP_CONTENT, 0);
     ...
     * @return PopupDialog
     */
    public static PopupDialogUtils create(Context context, String title, String message, String confirm, View.OnClickListener
        ...
        PopupDialogUtils dialog = new PopupDialogUtils(context, cancelable, canceledOnTouchOutside);
     ...
     * @return PopupDialog
     */
    public static PopupDialogUtils create(Context context, int titleRes, int messageRes, int confirmRes, View.OnClickListener
